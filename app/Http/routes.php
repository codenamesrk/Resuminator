...
Route::group([ 'domain' => 'resume.dev', 'as' => 'user::' ], function(){	
	...
	Route::group(['middleware' => ['payment']], function(){		
		Route::post('payment/response', [ 'as' => 'payment.response', 'uses' => 'RegistrationController@postPayment' ]);
	});
});


Route::group(['domain' => 'admin.resume.dev', 'as' => 'admin::'], function () {
	Route::group([ 'middleware' => ['web']], function () {
		// Auth Route
		Route::auth();
		// App Routes
